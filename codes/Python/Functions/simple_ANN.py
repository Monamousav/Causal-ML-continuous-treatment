...
def train_simple_ann_model_from_splits(data_2nd_stage, evall_N_seq, split_csv_path, folder_name, device):
    ...
    for _, row in splits_df.iterrows():
        ...
        dataset = dataset[['yield', 'Nk', 'plateau', 'b0', 'N']]
...
def run_model(model_type, n_fields, data_2nd_stage, evall_N_seq, device):
    ...
    if model_type == "SimpleANN":
        train_simple_ann_model_from_splits(data_2nd_stage, evall_N_seq, split_csv_path, folder_name, device)
