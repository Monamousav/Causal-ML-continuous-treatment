...
def NO_RF_model_from_splits(data_2nd_stage, evall_N_seq, split_csv_path, folder_name):
...
def run_model(model_type, n_fields, data_2nd_stage, evall_N_seq, device):  # <- added device here
    ...
    if model_type == "NO_RF":
        NO_RF_model_from_splits(data_2nd_stage, evall_N_seq, split_csv_path, folder_name)
